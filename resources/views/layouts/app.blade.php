...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/random-drinks') }}">
                    <img class="brand-logo" src="{{ asset('the-fizz-smiths-logo.png') }}" alt="Brand-logo">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ url('/random-drinks') }}">All</a></li>
                        <li><a class="dropdown-item" href="{{ url('/random-drinks?category=1') }}">Classic</a></li>
                        <li><a class="dropdown-item" href="{{ url('/random-drinks?category=2') }}">Ordinary</a></li>
                        <li><a class="dropdown-item" href="{{ url('/random-drinks?category=3') }}">Non Alcholic</a></li>
